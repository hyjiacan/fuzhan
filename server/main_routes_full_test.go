...
func TestMainRouteTreeNoConflict(t *testing.T) {
    ...
    db.POST("/test-connection", dummy)
    db.POST("/migration-check", dummy)
    db.POST("/migrate", dummy)
    db.GET("/status", dummy)
    db.POST("/cancel", dummy)
    db.POST("/resume", dummy)
    db.POST("/restart", dummy)
    db.POST("/rollback", dummy)
    db.GET("/backups", dummy)
    db.POST("/backups", dummy)
    db.POST("/backups/restore", dummy)
    db.DELETE("/backups/:id", dummy)
